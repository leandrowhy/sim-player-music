<template>
	<view>
		<cu-custom class="nav-bar" :isBack="true" :bgImgBlur="bgimg" backText="返回" :content="album.name"></cu-custom>
...
export default {
	...
	computed: {
		targetMuLenght(){
			return this.targetMuList.length
		},
		targetMuList() {
		...
		tracksLenght() {
			// console.log()
			return this.album.tracks && this.album.tracks.length;
		}
	},
	methods: {
		getData(id) {
